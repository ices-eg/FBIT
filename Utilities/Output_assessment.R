...
##### Figure A.1
  ...
  pdf(paste(Assregion,AssYear,"figureA1-a.pdf",sep="_"),width=7.5,height=5.5) 
  print(map_plot(Region,"SurfaceSAR",AssYear,purples,Assregion))
  dev.off()
  
  pdf(paste(Assregion,AssYear,"figureA1-b.pdf",sep="_"),width=7.5,height=5.5) 
  print(map_plot(Region,"impact",AssYear,bluegreen,Assregion))
  dev.off()
  
  pdf(paste(Assregion,AssYear,"figureA1-c.pdf",sep="_"),width=7.5,height=5.5) 
  print(map_plot(Region,"totweight",AssYear,yellowred,Assregion))
  dev.off()
 
   pdf(paste(Assregion,AssYear,"figureA1-d.pdf",sep="_"),width=7.5,height=5.5) 
  print(map_plot(Region,"totvalue",AssYear,yellowred,Assregion))
  dev.off()
...
##### Figure A.2
  ...
  } else if (Assregion == "Celtic Seas"){ 
    coordslim <- c(-15, 3, 48 , 62.5)
    coordxmap <- c(-12,-6,0)
    coordymap <- c(49,55,61)
  }
  
  pdf(paste(Assregion,AssYear,"figureA2.pdf",sep="_"),width=8,height=4.5) 
  figmap <- ggplot() + geom_point(data=Habitat, aes(x=longitude, y=latitude, colour=EUNIS),shape=15,size=.05,na.rm=T)
...
##### Figure A.3
  ...
  pdf(paste(Assregion,AssYear,"figureA3-a.pdf",sep="_"),width=7.5,height=5.5) 
  print(map_plot(Region,"SurfaceSAR",AssYear,purples,Assregion))
  dev.off()
  
  pdf(paste(Assregion,AssYear,"figureA3-b.pdf",sep="_"),width=7.5,height=5.5) 
  print(map_plot(Region,"SurfaceSAR",AssPeriod,purples,Assregion))
  dev.off()
  
  pdf(paste(Assregion,AssYear,"figureA3-c.pdf",sep="_"),width=7.5,height=5.5) 
  print(map_plot(Region,"Subsurface",AssYear,purples,Assregion))
  dev.off()
  
  pdf(paste(Assregion,AssYear,"figureA3-d.pdf",sep="_"),width=7.5,height=5.5) 
  print(map_plot(Region,"Subsurface",AssPeriod,purples,Assregion))
  dev.off()

##### Figure A.4 (EUNIS differs from demonstration product)
  ...
  plot(left[,1]~left$Year,type="o",col="black",lwd=2, pch=16, yaxt="n",ylim=c(0,4),
...
# Figure A.6
  pdf(paste(Assregion,AssYear,"figureA6.pdf",sep="_"),width=5.5,height=4.5) 
  print(map_plot(Region,"impact",AssYear,bluegreen,Assregion))
  dev.off()
...
# Figure A.10
  pdf(paste(Assregion,AssYear,"figureA10-a.pdf",sep="_"),width=7.5,height=5.5) 
  print(map_plot(Region,"state",AssYear,bluegreen,Assregion))
  dev.off()
  
  pdf(paste(Assregion,AssYear,"figureA10-b.pdf",sep="_"),width=7.5,height=5.5) 
  print(map_plot(Region,"state",AssPeriod,bluegreen,Assregion))
  dev.off()
...
# Figure A.13
  ...
  figmap <- ggplot() + geom_point(data=A13fig, aes(x=longitude, y=latitude, colour=factor(cat)),shape=15,size=.05,na.rm=T) +
  ...
  pdf(paste(Assregion,AssYear,"figureA13-a.pdf",sep="_"),width=7.5,height=5.5) 
  print(figmap_05)  
  dev.off()
  ...
  pdf(paste(Assregion,AssYear,"figureA13-b.pdf",sep="_"),width=7.5,height=5.5) 
  print(figmap_10)  
  dev.off()
...
# Table A3
  ...
  colnames(A3table) <- c("EUNIS habitat code","Extent of habitat (10^3 km^2)", "Landings 10^3 tonnes", "Value 10^6 euro",
...
# Table A5
  ...
  colnames(A5table) <- c("EUNIS habitat code", "Total area km^2","Total value euro","Area with the least value constituting 5% of the swept area",
